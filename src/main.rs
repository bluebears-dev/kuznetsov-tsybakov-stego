...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let image_encoder = RandomTraversingEncoder::new(gray_image.len(), 1337);
    let probabilities = image_encoder.get_probabilities(gray_image, 1, 1);
    let coder = StandardKTEncoder::new(1337);
